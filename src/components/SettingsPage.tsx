        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-300 dark:border-slate-700 rounded-3xl p-6 shadow-sm space-y-5">
          ...
          <div className="space-y-4 text-xs">
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Require a 6-digit PIN code to unlock the application whenever you open Reflect after logging in.
            </p>

            {pinEnabled ? (
              <div className="space-y-3">
                <div className="p-3.5 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200/80 dark:border-emerald-900/50 flex items-center justify-between">
                  <div className="space-y-0.5">
                    <span className="font-semibold text-emerald-950 dark:text-emerald-200 block">
                      6-Digit PIN Lock Enabled
                    </span>
                    <span className="text-[11px] text-emerald-800/70 dark:text-emerald-400/70">
                      Your reflections are protected on this device
                    </span>
                  </div>
                ...
                <div className="flex gap-2.5 pt-1">
                  <button
                    ...
                    className="flex-1 px-3.5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs shadow-xs transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                  >
              ...
              <div className="space-y-3">
                <div className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 space-y-1">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">
                    Set up an optional 6-digit PIN lock for extra privacy when accessing your journal.
                  </p>
                </div>
